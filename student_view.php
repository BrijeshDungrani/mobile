...
<table width="90%" border="1" align="center">
  ...
  <tr>
    ...
    <td width="13%"><?php echo $_SESSION['username']; ?> </td>
  </tr>
  <tr>
    <td>strength</td>
    <td>&nbsp;</td>
...
<table width="92%" height="50" border="1" align="center">
  <tr>
  ...
  <tr>
    <th width="150"><div align="center"><input type="checkbox" name="cck_all" id="cck_all" onclick="check_all(this)"/></div></th>
    <th width="153"><div align="center">student_id</div></th>
    <th width="211"><div align="center">student_name</div></th>
    <th width="128">surname</th>
    <th width="154">roll_no </th>
    <th width="184">attendance</th>
    <th width="184">Action</th>
  </tr>
  <?php
